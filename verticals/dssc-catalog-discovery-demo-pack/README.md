...
```bash
node tools/run-dssc-catalog-discovery-fixtures.mjs
```
...
Current GLiNER Docker candidate pass: `dssc-catalog-discovery-gliner-docker-pass-2026-04-14` (image: `gliner-extractor:latest`).
