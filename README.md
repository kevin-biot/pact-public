...
Run the telco fault diagnosis demo fixture harness:

```bash
node tools/run-telco-fault-diagnosis-fixtures.mjs
```

Run the telco RAN/Core/Slice demo fixture harness:
...
Run the FHIR encounter transitions fixture harness:
...
Run the benefit-allocation risk evolution demo fixture harness:
...
4. `verticals/commerce-cross-platform-fusion-demo-pack/`
5. `verticals/iso20022-reference-pack/`
6. `verticals/iso20022-authored-demo-pack/`
7. `verticals/iso20022-canonical-demo-pack/`
8. `verticals/openbanking-ais-read-demo-pack/`
9. `verticals/openbanking-consent-lifecycle-demo-pack/`
10. `verticals/openbanking-payment-initiation-demo-pack/`
11. `verticals/policy-reference-pack/`
12. `verticals/policy-reference-pack-denywins-off/`
13. `verticals/revolut-merchant-core-seed-pack/`
14. `verticals/revolut-merchant-customer-subscription-surface-pack/`
15. `verticals/revolut-merchant-disputes-surface-pack/`
16. `verticals/revolut-merchant-order-payment-surface-pack/`
17. `verticals/revolut-merchant-ops-observability-surface-pack/`
18. `verticals/shopify-functions-core-seed-demo-pack/`
19. `verticals/shopify-functions-discount-surface-demo-pack/`
20. `verticals/shopify-functions-validation-surface-demo-pack/`
21. `verticals/shopify-functions-delivery-fulfillment-surface-demo-pack/`
22. `verticals/shopify-functions-payment-surface-demo-pack/`
23. `verticals/shopify-functions-cart-transform-surface-demo-pack/`
24. `verticals/tmf-core-seed-demo-pack/`
25. `verticals/tmf-service-inventory-order-surface-demo-pack/`
26. `verticals/tmf-resource-catalog-alarm-surface-demo-pack/`
27. `verticals/tmf-intent-policy-bridge-surface-demo-pack/`
28. `verticals/telco-reference-pack/`
29. `verticals/telco-retail-demo-pack/`
30. `verticals/telco-fault-diagnosis-demo-pack/`
31. `verticals/telco-ran-core-slice-demo-pack/`
32. `verticals/travel-air-shopping-demo-pack/`
...
The cross-platform commerce fusion demo pack stitches Open Banking, Shopify checkout functions, and ISO 20022 rail semantics into a single deterministic journey.
